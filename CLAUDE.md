# solar-journey-platform — AI Assistant Instructions
...
## Project context:
- **Description**: An intelligent lead conversion platform that automates the journey from form submission to scheduled appointments for solar companies, designed to replace expensive tools like Demand IQ.
...
## Quick commands (run from repo root: `~/Documents/Claude/projects/solar-journey-xdemandiq`):
```bash
npm run dev                                       # local dev server
docker build -t solar-journey-xdemandiq .                        # test Docker build locally
